  ...
  [2],
  {
    '+su7': function (e, t, r) {
      ...
      var l = function (e) {
        ...
        return n['default'].createElement(
          'span',
          o({ className: '__dumi-default-badge' }, r),
          t,
        )
      }
      t['default'] = l
    ...
    '3Mpw': function (e, t, r) {
              ...
              clone: function (e, r) {
                ...
                switch (((r = r || {}), n)) {
                  case 'Object':
                    ...
                    o = {}
                    for (var a in ((r[t.util.objId(e)] = o), e))
                      e.hasOwnProperty(a) && (o[a] = t.util.clone(e[a], r))
                    return o
                  case 'Array':
                    if (r[t.util.objId(e)]) return r[t.util.objId(e)]
                    var o = []
                  ...
                  e.hasOwnProperty(o) &&
                    ...
                    'Object' !== t.util.type(e[o]) || a[t.util.objId(e[o])]
                      ? 'Array' !== t.util.type(e[o]) ||
                        a[t.util.objId(e[o])] ||
                        ((a[t.util.objId(e[o])] = !0),
                        t.languages.DFS(e[o], r, o, a))
                      : ((a[t.util.objId(e[o])] = !0),
                        t.languages.DFS(e[o], r, null, a)))
              },
            },
            plugins: {},
                    ...
                    for (
                      ...
                      if (!(E instanceof l)) {
                        if (m && v != r.length - 1) {
                          ...
                          if (!S) break
                          for (
                            var k = S.index + (g ? S[1].length : 0),
                              A = S.index + S[0].length,
                              O = v,
                              x = w,
                              T = r.length;
                            O < T &&
                            (x < A || (!r[O].type && !r[O - 1].greedy));
                            ++O
                          )
                            (x += r[O].length), k >= x && (++v, (w = x))
                          if (r[v] instanceof l) continue
                          ;(_ = O - v), (E = e.slice(w, x)), (S.index -= w)
                        } else {
                          d.lastIndex = 0
                          S = d.exec(E)
                          var _ = 1
                        ...
                        if (S) {
                          ...
                          var L = new l(c, f ? t.tokenize(S, f) : S, h, S, m)
                          if (
                            (R.push(L),
                            I && R.push(I),
      ...
      ;(n.languages.markup = {
              ...
              for (var a = [], o = 0; o < n.length; o++) {
                ...
                if (
                  ...
                  o < n.length - 1 &&
                    ...
                    ((l += r(n[o + 1])), n.splice(o + 1, 1)),
                    o > 0 &&
                      ('string' === typeof n[o - 1] ||
                        'plain-text' === n[o - 1].type) &&
                      ((l = r(n[o - 1]) + l), n.splice(o - 1, 1), o--),
                    (n[o] = new e.Token('plain-text', l, null, l))
                }
        ...
        (function (e) {
          ...
          function r(t, r) {
            ...
            if (a) {
              ...
              if (
                (o instanceof RegExp && (o = a[n] = { pattern: o }),
                Array.isArray(o))
              )
        ...
        (function (e) {
          ...
          function c(t) {
            ...
            if (3 === o.length) {
              var i = [1, 1]
              i.push.apply(i, l(o[1], e.languages.javascript, 'javascript')),
                o.splice.apply(o, i)
            }
        ...
        (n.languages.python['string-interpolation'].inside[
          'interpolation'
        ].inside.rest = n.languages.python),
      ...
      var d = /\r\n|\r|\n/,
        ...
        b = function (e, t) {
          ...
          return (
            (a.root = r), (a.plain = p({}, r, { backgroundColor: null })), a
          )
        }
      function h(e, t) {
        var r = {}
          ...
          e.apply(this, r),
            ...
            u(this, 'getLineProps', function (e) {
              ...
              return (
                ...
                void 0 !== a &&
                  (s.style = void 0 !== s.style ? p({}, s.style, a) : a),
                void 0 !== r && (s.key = r),
                n && (s.className += ' ' + n),
                s
              )
            ...
            u(this, 'getTokenProps', function (e) {
              ...
              return (
                void 0 !== a &&
                  (l.style = void 0 !== l.style ? p({}, l.style, a) : a),
                void 0 !== r && (l.key = r),
                n && (l.className += ' ' + n),
                l
              )
                ...
                var t,
                  ...
                  g = {
                    files: y(
                      ...
                      v(t, 'demo.'.concat(f), { content: n.tsx || n.jsx }),
                      v(t, 'index.'.concat(f), {
                    ...
                    devDependencies: d ? { typescript: '^3.8.0' } : {},
                    desc: (0, a['default'])(i),
                    template: 'create-react-app'.concat(d ? '-typescript' : ''),
                    fileName: 'demo.'.concat(f),
                  }
                e.setState({
                  CSBData: (0, s['default'])(g, { name: l || 'dumi-demo' })
                    .parameters,
                })
              }),
                    ...
                    : n['default'].createElement(
                        ...
                        n['default'].createElement(
                          'div',
                          {
                            ...
                            style: {
                              transform: h ? 'translate(0, 0)' : void 0,
                              padding: v ? '0' : void 0,
                              background: y,
                            },
                          },
                        ...
                        n['default'].createElement(
                          ...
                          p.tsx &&
                            ...
                            n['default'].createElement('button', {
                              className: '__dumi-default-icon',
                              role: 'change-'.concat(x),
                              type: 'button',
                              onClick: function () {
                                return s.setState({
                                  sourceType: 'tsx' === x ? 'jsx' : 'tsx',
                                })
                              },
                            }),
                          n['default'].createElement('button', {
                            ...
                            type: 'button',
                            onClick: function () {
                              return s.setState({ showSource: !O })
                            },
                          }),
                        ),
                        O &&
                                  ...
                                  return n['default'].createElement(
                                    ...
                                    n['default'].createElement(
                                      'button',
                                      {
                                        type: 'button',
                                        onClick: function () {
                                          return s.setState({ currentFile: e })
                                        },
                                      },
                                      e,
                                    ),
    ...
    B2uJ: function (e, t, r) {
      ...
      var l = function (e) {
        ...
        return n['default'].createElement(
          'div',
          o({ className: '__dumi-default-alert' }, r),
          t,
        )
      }
      t['default'] = l
    ...
    R2QN: function (e, t, r) {
      ...
      var p = function (e, t) {
        ...
        var u = t,
          p = u.extraFiles,
          d = u.extraDependencies,
          f = u.name,
          g = u.template,
          m = void 0 === g ? 'create-react-app' : g,
          b = t,
          h = b.main,
          y = s(s({}, o), d)
        ;(h =
          h || 'create-react-app-typescript' !== m ? 'index.jsx' : 'index.tsx'),
          c(y)
        var v = s(
            s({}, r),
            {},
            {
              'package.json': {
                content: (0, a.newpkgJSON)(y, f, h, i || {}, l),
              },
              'sandbox.config.json': {
                content: JSON.stringify({ template: m }),
              },
            },
            p,
          ),
          w = (0, n['default'])({ files: v })
        return { files: v, dependencies: y, parameters: w }
      }
      t['default'] = p
    },
    UClF: function (e, t, r) {
                ...
                if ((n && 'object' !== c(n)) || Array.isArray(n))
                  return new Error(
                    "Invalid props '"
                      ...
                      .concat(r, "'. ") + "'".concat(t, "' is not an object."),
                  )
